<?php
// movieDB 데이터베이스 연결
$conn = mysqli_connect("localhost", "movie user", "1234", "movieDB") or die("movieDB 접속 실패!!!");
...
if(isset($_POST["movieTitle2"]) && isset($_POST["movieGenre2"]) && isset($_POST["movieYear2"]) && isset($_POST["moviePrice2"])) {
    ...
    $year = $_POST["movieYear2"];
    $price = $_POST["moviePrice2"];
    
    $sql = "UPDATE movie SET title = '$title', genre = '$genre', year = '$year', price = '$price' WHERE title = '$title'";
